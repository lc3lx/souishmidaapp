...
// @access  Private
router.get('/providers', auth, SMMController.getProviders);

// @route   POST /api/smm/providers
// @desc    Add new SMM provider
// @access  Private
router.post('/providers', auth, validateProvider, SMMController.addProvider);

// @route   PUT /api/smm/providers/:id
// @desc    Update SMM provider
// @access  Private
router.put('/providers/:id', auth, validateId, SMMController.updateProvider);

// @route   DELETE /api/smm/providers/:id
// @desc    Delete SMM provider
// @access  Private
router.delete('/providers/:id', auth, validateId, SMMController.deleteProvider);

// @route   PATCH /api/smm/providers/:id/toggle
// @desc    Toggle provider status (active/inactive)
// @access  Private
router.patch('/providers/:id/toggle', auth, validateId, SMMController.toggleProvider);

// @route   POST /api/smm/providers/:id/sync
// @desc    Sync provider services
// @access  Private
router.post('/providers/:id/sync', auth, validateId, SMMController.syncServices);

// @route   GET /api/smm/providers/:id/services
// @desc    Get provider services
// @access  Private
router.get('/providers/:id/services', auth, validateId, SMMController.getServices);

// @route   POST /api/smm/orders
// @desc    Create new SMM order
// @access  Private
router.post('/orders', auth, validateOrder, SMMController.createOrder);

// @route   GET /api/smm/orders
// @desc    Get user's SMM orders
// @access  Private
router.get('/orders', auth, SMMController.getOrders);

// @route   GET /api/smm/orders/:id
// @desc    Get specific SMM order
// @access  Private
router.get('/orders/:id', auth, validateId, async (req, res) => {
  try {
...
// @access  Private
router.post('/orders/:id/refill', auth, validateId, async (req, res) => {
  try {
    const SMMOrder = require('../models/SMMOrder');
...
// @desc    Cancel order
// @access  Private
router.post('/orders/:id/cancel', auth, validateId, async (req, res) => {
  try {
    const SMMOrder = require('../models/SMMOrder');
    const SMMService = require('../utils/smmService');
...
// @access  Private
router.post('/providers/test', auth, [
